...
def main(
    ...
    st.sidebar.title("Поздравление от Евгения для Анастасии и Екатерины")
    ...
    st.markdown("<h1 style='text-align: center; '>Анастасия и Екатерина ! Поздравляю с наступающим международным женским днём !</h1>", unsafe_allow_html = True)
    
    st.write("Прекрасны по весне цветы, но женщины еще прекрасней. В этот день желаю Вам любви и счастья! Благополучия в семье и мужской заботы, удачи во всех делах и вдохновения в работе !")
    ...
    st.image('8mmm.gif')
    st.write("Кроме цветов, атрибут праздничного настроения, конечно же, шарики. По кнопочке, расположенной ниже, сможете запускать их в любое время !")

    
    if st.button("Шарики c сюрпризом для улучшения настроения :)"):
